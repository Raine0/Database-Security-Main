...
<header class="header">
   ...
   <section class="flex">
      ...
      <div class="icons">
         <?php if (!empty($user_role)) { echo '<div id="menu-btn" class="fas fa-bars"></div>';}?>
...
if (!empty($user_role)) {
    ...
    if ($fetch_profile) {
        echo '<img src="../uploaded_files/'. $fetch_profile['image']. '" alt="">';
